...
describe("Consciousness State Workbench - Main Test Suite", () => {
  ...
  describe("Consciousness State Capture", () => {
    ...
    test("should handle capture failures gracefully", async () => {
      ...
      await expect(workbench.captureState({})).rejects.toThrow(
        "Capture failed"
      );
    });
  ...
  describe("State Persistence", () => {
    ...
    test("should handle corrupted state gracefully", async () => {
      ...
      await expect(
        workbench.loadState({ stateId: "corrupted" })
  ...
  describe("Swarm Processing", () => {
    ...
    test("should handle swarm processing failures", async () => {
      workbench.processWithSwarm.mockRejectedValue(
        new Error("Swarm processing failed")
      );

      await expect(workbench.processWithSwarm({})).rejects.toThrow(
  ...
  describe("Error Handling", () => {
    ...
    test("should provide meaningful error messages", async () => {
      ...
      await expect(workbench.transformState({})).rejects.toThrow(
        "Quantum layer synchronization failed"
      );
    });
  });
