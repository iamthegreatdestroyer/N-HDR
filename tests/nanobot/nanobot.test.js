...
const {
  ConsciousnessLayer,
} = require("../../src/consciousness/consciousness-layer");
const {
  StatePreservation,
} = require("../../src/consciousness/state-preservation");
...
describe("NanoBot", () => {
  ...
  beforeEach(() => {
    ...
    consciousnessLayerStub = sinon
      .stub(ConsciousnessLayer.prototype, "processState")
      .resolves({ id: "test", processed: true });

    statePreservationStub = sinon
      .stub(StatePreservation.prototype, "preserveState")
      .resolves();
  });
