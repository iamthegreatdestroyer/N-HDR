...
describe("Monte Carlo Engine Integration", () => {
  ...
  describe("assessRisk", () => {
    ...
    it("should identify safest and riskiest pathways", () => {
      ...
      const safeRisk = result.pathwayRisks.find((r) => r.id === "very-safe");
      const riskyRisk = result.pathwayRisks.find((r) => r.id === "very-risky");
    ...
    it("should compute VaR and CVaR", () => {
      const pathways = [{ id: "test", probability: 0.5, impact: 0.5 }];
    ...
    it("should provide percentiles", () => {
      const pathways = [{ id: "p", probability: 0.5, impact: 0.5 }];
