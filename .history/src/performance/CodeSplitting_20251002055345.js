...
export const loadNanoSwarmHDR = () =>
  moduleLoader.load("../core/nano-swarm/NanoSwarmManager.js");
export const loadOmniscientHDR = () =>
  moduleLoader.load("../ohdr/OmniscientHDRSystem.js");
export const loadRealityHDR = () =>
  moduleLoader.load("../core/reality-hdr/RealityCompressor.js");
export const loadQuantumHDR = () =>
  moduleLoader.load("../core/quantum-hdr/QuantumStateManager.js");
export const loadDreamHDR = () =>
  moduleLoader.load("../core/dream-hdr/DreamPatternEngine.js");
export const loadVoidBladeHDR = () =>
  moduleLoader.load("../core/void-blade-hdr/VoidBladeSecuritySystem.js");
