      ...
      properties: {
        github: {
          ...
          properties: {
            ...
            defaultOwner: { type: 'string', description: 'Default repository owner' },
        ...
        readthedocs: {
          type: 'object',
          properties: {
            defaultProject: { type: 'string', description: 'Default project name' },
            defaultVersion: { type: 'string', description: 'Default documentation version', default: 'latest' },
            customDomain: { type: 'string', description: 'Custom documentation domain' }
          }
        },
        swagger: {
          type: 'object',
          properties: {
            defaultUrl: { type: 'string', description: 'Default Swagger documentation URL' },
            uiOptions: {
              type: 'object',
              description: 'Swagger UI customization options',
              properties: {
                theme: { type: 'string', enum: ['default', 'dark', 'custom'], default: 'default' },
                customCss: { type: 'string', description: 'Custom CSS for Swagger UI' },
                customJs: { type: 'string', description: 'Custom JavaScript for Swagger UI' }
              }
            }
          }
        }
