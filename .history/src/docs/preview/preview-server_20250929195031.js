...
<head>
  ...
  <!-- Syntax highlighting -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.7.0/styles/${this.options.syntaxTheme}.min.css">
  
  <!-- Custom styles -->
  ${this.options.customStyles.map(style => 
...
<body>
  ...
  ${this.options.customScripts.map(script => 
