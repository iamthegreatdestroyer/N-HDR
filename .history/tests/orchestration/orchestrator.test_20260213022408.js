...
const HDROrchestrator = require("../../src/hdr-orchestrator");
const GenesisHDR = require("../../src/genesis-hdr/genesis-core");
const OracleCore = require("../../src/oracle-hdr/oracle-core");
const DiffusionHDR = require("../../src/diffusion-hdr/diffusion-core");
const logger = require("../../src/utils/logger");

// Mock logger and sub-systems
...
jest.mock("../../src/genesis-hdr/genesis-core");
jest.mock("../../src/oracle-hdr/oracle-core");
jest.mock("../../src/diffusion-hdr/diffusion-core");
