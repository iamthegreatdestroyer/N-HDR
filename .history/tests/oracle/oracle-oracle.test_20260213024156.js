...
describe("ORACLE-HDR Oracle Core", () => {
  ...
  describe("Circuit Breaker Configuration", () => {
    ...
    test("should log when circuit breaker threshold is set", () => {
      ...
      expect(oracle.circuitBreakerThreshold).toBe(8);
      expect(oracle.failureCount).toBe(0);
    });
  });
  ...
  describe("Successful Predictions", () => {
    ...
    test("should emit prediction:made event on successful prediction", (done) => {
      ...
      oracle.on("prediction:made", (data) => {
        eventData = data;
        eventFired = true;
      });
      ...
      setImmediate(() => {
        ...
        expect(eventData).toHaveProperty("prediction_id");
        expect(eventData).toHaveProperty("agent_id");
        expect(eventData).toHaveProperty("outcome");
  ...
  describe("Configuration Persistence", () => {
    test("should preserve custom configuration", () => {
      const customOracle = new OracleHDR({
        maxCascadeDepth: 10,
