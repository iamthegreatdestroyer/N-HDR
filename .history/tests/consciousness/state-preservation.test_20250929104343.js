...
describe('StatePreservation', () => {
  ...
  describe('State Preservation', () => {
    ...
    test('should fail gracefully on preservation error', async () => {
      ...
      await expect(preservation.preserveState('layer1', mockState))
  ...
  describe('State Restoration', () => {
    ...
    test('should fail for non-existent snapshot', async () => {
      await expect(preservation.restoreState('fake-id'))
    ...
    test('should fail on integrity check failure', async () => {
      ...
      await expect(preservation.restoreState(snapshotId))
        .rejects.toThrow('Snapshot integrity verification failed');
    });
  });
  ...
  describe('Snapshot Management', () => {
    beforeEach(async () => {
      ...
      await preservation.preserveState('layer1', { nodes: [], connections: [] });
      await preservation.preserveState('layer2', { nodes: [], connections: [] });
    });
