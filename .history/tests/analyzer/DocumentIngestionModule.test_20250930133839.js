...
describe('DocumentIngestionModule', () => {
  ...
  describe('createQuantumEmbeddings', () => {
    it('should create quantum-enhanced embeddings', async () => {
      const embeddings = await ingestionModule.createQuantumEmbeddings(mockDocument);
    ...
    it('should add quantum noise to embeddings', async () => {
      const baseEmbeddings = await ingestionModule.createQuantumEmbeddings(mockDocument);
      const enhancedEmbeddings = await ingestionModule.createQuantumEmbeddings(mockDocument);
