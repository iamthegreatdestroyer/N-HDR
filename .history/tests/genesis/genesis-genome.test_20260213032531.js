...
describe('AgentGenome Tests', () => {
  describe('Initialization', () => {
    ...
    test('should have valid personality traits', () => {
      const personalities = ['analytical', 'creative', 'pragmatic', 'empathetic', 'bold'];
  ...
  describe('Gene Randomization', () => {
    ...
    test('should randomize problem-solving strategies', () => {
      ...
      const newStrategy = genome.randomizeGeneTrait('strategy');

      expect(validStrategies).toContain(newStrategy);
    });

    test('should randomize domain specializations from valid set', () => {
      const genome = new AgentGenome('test-agent-specialization', 0);
      ...
      const newSpecialization = genome.randomizeGeneTrait('domainSpecialization');

      expect(validSpecializations).toContain(newSpecialization);
    });
  });
