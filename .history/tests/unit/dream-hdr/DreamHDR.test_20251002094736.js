...
describe('SubconsciousPatternEncoder', () => {
  ...
  beforeAll(async () => {
    const module = await import('../../../src/core/dream-hdr/SubconsciousPatternEncoder.js');
...
describe('CreativityAmplifier', () => {
  ...
  beforeAll(async () => {
    const module = await import('../../../src/core/dream-hdr/CreativityAmplifier.js');
...
describe('PatternRecognizer', () => {
  ...
  beforeAll(async () => {
    const module = await import('../../../src/core/dream-hdr/PatternRecognizer.js');
...
describe('IntuitionEngine', () => {
  ...
  beforeAll(async () => {
    const module = await import('../../../src/core/dream-hdr/IntuitionEngine.js');
