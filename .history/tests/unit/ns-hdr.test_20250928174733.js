...
describe('NanoSwarmHDR Tests', () => {
  ...
  describe('Initialization', () => {
    test('should initialize with correct configuration', () => {
      ...
      expect(nsHdr.targetAcceleration).toBe(config.acceleration.accelerationTarget);
  ...
  describe('Processing Acceleration', () => {
    ...
    test('should not exceed maximum generations', async () => {
      ...
      expect(nsHdr.generations).toBeLessThanOrEqual(config.acceleration.maxGenerations);
    });
  });
  ...
  describe('Quantum Optimization', () => {
    ...
    test('should optimize quantum processing', async () => {
      ...
      expect(result.entanglement).toBeGreaterThanOrEqual(mockQuantumState.entanglement);
      expect(result.coherence).toBeGreaterThanOrEqual(mockQuantumState.coherence);
      expect(result.superposition).toBeGreaterThanOrEqual(mockQuantumState.superposition);
    });
  });
  ...
  describe('Swarm Evolution', () => {
    ...
    test('should maintain elite particles', async () => {
      ...
      const particles = Array.from(nsHdr.swarm.values())
