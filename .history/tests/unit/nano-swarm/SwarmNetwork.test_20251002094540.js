...
const { SwarmNetwork } = require('../../../src/core/nano-swarm/nano-swarm-hdr');
...
describe('SwarmNetwork', () => {
  ...
  describe('distributeProcessing()', () => {
    ...
    test('should distribute processing successfully', async () => {
      const result = await swarmNetwork.distributeProcessing(testData, mockAccelerator);
    ...
    test('should handle null data', async () => {
      const result = await swarmNetwork.distributeProcessing(null, mockAccelerator);
      expect(result).toBeNull();
    });

    test('should handle undefined accelerator', async () => {
      const result = await swarmNetwork.distributeProcessing(testData, undefined);
      expect(result).toBeDefined();
    });

    test('should handle empty data object', async () => {
      const result = await swarmNetwork.distributeProcessing({}, mockAccelerator);
    ...
    test('should preserve data structure', async () => {
      ...
      const result = await swarmNetwork.distributeProcessing(complexData, mockAccelerator);
  ...
  describe('Performance Tests', () => {
    ...
    test('should handle concurrent processing requests', async () => {
      const mockAccelerator = { accelerate: jest.fn(d => Promise.resolve(d)) };
      const requests = [];
  ...
  describe('Integration Tests', () => {
    ...
    test('should support chained operations', async () => {
      ...
      const result = await mesh.distributeProcessing({ test: 'chained' }, mockAccelerator);
