...
describe('CriticalPathOptimizer', () => {
  ...
  beforeAll(async () => {
    const module = await import('../../../src/performance/CriticalPathOptimizer.js');
  ...
  describe('HDR System Optimizations', () => {
    ...
    test('should optimize all HDR systems', async () => {
      const systems = ['N-HDR', 'NS-HDR', 'O-HDR', 'R-HDR', 'Q-HDR', 'D-HDR', 'VB-HDR'];
...
describe('PerformanceBenchmark', () => {
  ...
  beforeAll(async () => {
    const module = await import('../../../src/performance/PerformanceBenchmark.js');
