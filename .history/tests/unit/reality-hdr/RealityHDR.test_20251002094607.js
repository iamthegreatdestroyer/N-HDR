...
describe('RealityHDR', () => {
  ...
  describe('importSpace()', () => {
    ...
    test('should handle import errors gracefully', async () => {
      await expect(realityHDR.importSpace(null))
        .rejects.toThrow('Failed to import space');
    });
  });
  ...
  describe('compressSpace()', () => {
    ...
    test('should throw error if no space loaded', async () => {
      ...
      await expect(emptySystem.compressSpace())
        .rejects.toThrow('No space loaded for compression');
    });
  ...
  describe('navigateSpace()', () => {
    ...
    test('should handle navigation errors', async () => {
      await expect(realityHDR.navigateSpace(null))
  ...
  describe('integrateWithNeuralHDR()', () => {
    ...
    test('should integrate with neural state', async () => {
      ...
      const integrated = await realityHDR.integrateWithNeuralHDR(mockNeuralState);
    ...
    test('should handle integration errors', async () => {
      await expect(realityHDR.integrateWithNeuralHDR(null))
        .rejects.toThrow('Neural-HDR integration failed');
    });
  });
