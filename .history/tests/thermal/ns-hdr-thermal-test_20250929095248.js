...
const { ThermalManager, TaskProcessor, CONFIG } = require('../../implementation/ns-hdr-consolidated');
...
class ThermalTestRunner {
  ...
  async testNormalOperation() {
    ...
    console.log('Temperature after normal load:', this.simulator.getTemperature());
    
    const isNormal = this.simulator.getTemperature() < CONFIG.thermal.throttleThreshold;
