...
describe('IntegrationManager', () => {
  ...
  describe('Initialization', () => {
    ...
    test('should initialize with custom options', () => {
      ...
      expect(integrationManager.options).toEqual(expect.objectContaining(customOptions));
    });
  ...
  describe('Pipeline Management', () => {
    ...
    test('should start pipeline', async () => {
      ...
      jest.spyOn(integrationManager, '_connectToSystem')
    ...
    test('should stop pipeline', async () => {
      ...
      jest.spyOn(integrationManager, '_disconnectFromSystem')
        .mockResolvedValue();
  ...
  describe('Data Transformation', () => {
    test('should apply transformations in sequence', async () => {
      ...
      integrationManager.registerTransformer('json', data => JSON.stringify(data));
      ...
      const result = await integrationManager._applyTransformations(mockData, transformations);
