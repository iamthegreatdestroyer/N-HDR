...
describe('Quantum Knowledge Explorer - Main Test Suite', () => {
  ...
  describe('Visualization', () => {
    ...
    test('should handle visualization errors gracefully', async () => {
      ...
      await expect(explorer.visualize({ invalidConfig: true }))
        .rejects.toThrow('Visualization failed');
    });
  });
  ...
  describe('Swarm Acceleration', () => {
    ...
    test('should handle swarm deployment failures', async () => {
      explorer.accelerate.mockRejectedValue(new Error('Swarm deployment failed'));
      
      await expect(explorer.accelerate({}))
        .rejects.toThrow('Swarm deployment failed');
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    test('should provide meaningful error messages', async () => {
      ...
      await expect(explorer.explore('test')).rejects.toThrow('O-HDR crystallization failed');
    });
