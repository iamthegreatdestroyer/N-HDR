...
const { OrchestrationEngine } = require('../../src/forge-hdr/core/orchestration-engine')
const { AnomalyDetector } = require('../../src/forge-hdr/core/anomaly-detector')
const { PerformanceProfiler } = require('../../src/forge-hdr/core/performance-profiler')
const { MetricsExporter } = require('../../src/forge-hdr/core/metrics-exporter')
...
describe('Integration Tests - Full System', () => {
  ...
  describe('Compliance Tracking Integration', () => {
    ...
    it('should generate compliance recommendations', async () => {
      ...
      const recommendations = policyOptimizer.generateComplianceRecommendations()
