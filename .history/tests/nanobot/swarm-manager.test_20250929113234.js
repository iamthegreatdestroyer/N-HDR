...
describe('SwarmManager', () => {
  ...
  beforeEach(() => {
    ...
    sinon.stub(QuantumEntanglement.prototype, 'createEntanglement')
      .callsFake(quantumEntanglementStub.createEntanglement);
    sinon.stub(QuantumEntanglement.prototype, 'synchronizeState')
      .callsFake(quantumEntanglementStub.synchronizeState);
    sinon.stub(QuantumEntanglement.prototype, 'breakEntanglement')
      .callsFake(quantumEntanglementStub.breakEntanglement);
    sinon.stub(QuantumEntanglement.prototype, 'getEntangledPairs')
  ...
  describe('State Processing', () => {
    ...
    it('should handle processing failures gracefully', async () => {
      ...
      sinon.stub(badBot, 'processState').rejects(new Error('Processing failed'));
