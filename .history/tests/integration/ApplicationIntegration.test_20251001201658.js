...
describe('Application Integration Tests', () => {
  ...
  describe('Quantum Explorer ↔ Consciousness Workbench', () => {
    ...
    test('should enhance consciousness state with knowledge insights', async () => {
      ...
      const insights = await quantumExplorer.explore({ domain: 'neuroscience' });
  ...
  describe('Three-Way Integration', () => {
    test('should coordinate all three applications', async () => {
      ...
      dashboard.launchApplication
        .mockResolvedValueOnce({ launched: true, application: 'quantum-knowledge-explorer' })
        .mockResolvedValueOnce({ launched: true, application: 'consciousness-workbench' });
  ...
  describe('Error Propagation', () => {
    test('should handle errors across applications', async () => {
      quantumExplorer.explore.mockRejectedValue(new Error('Exploration failed'));

      await expect(quantumExplorer.explore({})).rejects.toThrow('Exploration failed');

      // Dashboard should be notified of error
      dashboard.getState.mockReturnValue({
        errors: [{ application: 'quantum-knowledge-explorer', message: 'Exploration failed' }]
      });
