...
class OracleMcpServer {
  constructor(config = {}) {
    this.server = new McpServer({
      ...
      version: "10.2.0",
      description:
        "ORACLE-HDR Predictive Intelligence & Causal Modeling System",
    });
  ...
  setupTools() {
    ...
    this.server.tool(
      "oracle.predictConsequence",
      {
        description:
          "Predict single consequence of action with confidence level",
        inputSchema: {
          type: "object",
          properties: {
            action: {
            ...
            context: {
              type: "object",
              description:
                "Additional context (historicalPrecedent, riskLevel, etc.)",
              properties: {
    ...
    this.server.tool(
      ...
      {
        description:
          "Assess risk of decision across scenarios using VaR and CVaR",
        inputSchema: {
          type: "object",
          properties: {
            decision: {
    ...
    this.server.tool(
      "oracle.findBreakingPoint",
      {
        description:
          "Find parameter threshold where system fails or changes behavior",
        inputSchema: {
          type: "object",
          properties: {
            parameter: {
        ...
        result: {
          ...
          cascade: {
            ...
            summary: {
              ...
              averageImpact: (
                cascade.allImpacts.reduce((a, b) => a + b, 0) /
                cascade.allImpacts.length
              ).toFixed(4),
            },
