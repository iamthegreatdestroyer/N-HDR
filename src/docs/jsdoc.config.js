...
module.exports = {
  ...
  templates: {
    ...
    search: true,
    sort: true,
    stylesheets: ["./docs/styles/custom.css"],
    scripts: ["./docs/scripts/custom.js"],
    analytics: {
      ga: "UA-XXXXX-XXX",
    },
  },
  ...
  sections: {
    core: {
      ...
      files: ["src/core/*.js", "src/core/**/*.js"],
      order: ["NanoBot", "SwarmManager", "SwarmController"],
    },
    security: {
      title: "Security Components",
      files: ["src/core/security/*.js", "src/core/security/**/*.js"],
      order: [
    ...
    thermal: {
      ...
      files: ["src/core/thermal/*.js", "src/core/thermal/**/*.js"],
      order: ["ThermalManager", "AdaptiveThrottling", "PredictiveCooling"],
    },
    consciousness: {
      title: "Consciousness Layer",
      files: ["src/core/consciousness/*.js", "src/core/consciousness/**/*.js"],
      order: [
        "ConsciousnessLayer",
        "StatePreservation",
        "QuantumEntanglement",
    ...
    api: {
      ...
      order: ["ApiServer", "WebSocketServer", "IntegrationManager"],
    },
  },
};
